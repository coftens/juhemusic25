...
class _SearchPageState extends State<SearchPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadHistory() async {
    ...
    final raw = sp.getStringList(_kSearchHistory) ?? const [];
    final next = [
      for (final h in raw)
                              ...
                              children: [
                                ...
                                if (_history.isEmpty)
                                  Padding(
                                    ...
                                    child: Text('暂无搜索历史', style: theme.textTheme.bodyMedium?.copyWith(color: Colors.black45)),
                                  )
                                else
                                  Wrap(
                                    spacing: 10,
                                    ...
                                    children: [
                                      for (final h in _history)
                                        _Chip(
                                          ...
                                          onDelete: () {
                                            final next = [for (final it in _history) if (it != h) it];
...
class _Chip extends StatelessWidget {
  const _Chip({required this.label, required this.onTap, this.onDelete});
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Text(label, style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.black87, fontWeight: FontWeight.w700)),
              if (onDelete != null) ...[
